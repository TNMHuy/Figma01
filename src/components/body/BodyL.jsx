    ...
    return (
      <div >
        ...
        <p style={{lineHeight: '50px',
         ...
         <div style={{padding:'80px',gap:'84px',width:'429px',height:'560px'}}>
            <img style={{width:'429px'}} src={img} alt="" />

            
                <div style={{display:'flex',paddingLeft:'64px',paddingTop:'70px',flexDirection:'column',gap:'24px',justifyContent:'center'}}>
                    <p style={{width:'301px'}} className='subBodyP1'>{content.h1}</p>
                    <p style={{width:'301px'}} className='subBodyP2'>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia.</p>
      </div>
