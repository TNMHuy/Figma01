...
const About = () => {
  ...
  return (
    <div className='py-12 mx-20'>
     ...
     <div id='body' className='mt-24'>
      <div id='subB' className='flex border-b border-black pb-12 mb-12 items-center justify-between'>
        <div className='flex items-center gap-12'>
          <img  className='rounded-full' src={au1} alt="" />
          <div className='text-[32px] font-bold leading-[120%]'>Jakob Grønberg</div>
        </div>
        <div>
        <div className='flex gap-24 '>
                <div className='flex justify-between items-center gap-2'>
                    <h4 className=' text-[14px] leading-[180%] font-bold'> Job</h4>
                    <p>Artist</p>
                </div>
                <div className='flex justify-between items-center gap-2'>
                <h4 className=' text-[14px] leading-[180%] font-bold'> City</h4>
                <p>Berlin</p>
                </div>
      ...
      <div id='subB' className='flex border-b border-black pb-12 mb-12 items-center justify-between'>
        <div className='flex items-center gap-12'>
          ...
          <div className='text-[32px] font-bold leading-[120%]'>Louise Jensen</div>
        </div>
        <div>
        <div className='flex gap-24 '>
                <div className='flex justify-between items-center gap-2'>
      ...
      <div id='subB' className='flex border-b border-black pb-12 mb-12 items-center justify-between'>
        <div className='flex items-center gap-12'>
          ...
          <div className='text-[32px] font-bold leading-[120%]'>Anne Henry</div>
        </div>
        <div>
        <div className='flex gap-24 '>
                <div className='flex justify-between items-center gap-2'>
      ...
      <div id='subB' className='flex border-b border-black pb-12 mb-12 items-center justify-between'>
        <div className='flex items-center gap-12'>
          ...
          <div className='text-[32px] font-bold leading-[120%]'>Anna Nielsen</div>
        </div>
        <div>
        <div className='flex gap-24 '>
                <div className='flex justify-between items-center gap-2'>
      ...
      <div id='subB' className='flex border-b border-black pb-12 mb-12 items-center justify-between'>
        <div className='flex items-center gap-12'>
          ...
          <div className='text-[32px] font-bold leading-[120%]'>Jane Cooper</div>
        </div>
        <div>
        <div className='flex gap-24 '>
                <div className='flex justify-between items-center gap-2'>
      ...
      <div id='subB' className='flex   mb-48 items-center justify-between'>
        <div className='flex items-center gap-12'>
          <img  className='rounded-full' src={au6} alt="" />
          <div className='text-[32px] font-bold leading-[120%]'>Cristofer Vaccaro</div>
        </div>
        <div>
        <div className='flex gap-24 '>
                <div className='flex justify-between items-center gap-2'>
