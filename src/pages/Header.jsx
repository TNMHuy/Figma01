...
import userImg from '../assets/6596121.png'
import logOut from '../assets/log-out-icon-2048x2048-cru8zabe.png'
        ...
        <div className='  border-b border-black h-[90px] flex justify-center items-center w-full ' >
            ...
            fyre magazine
             ...
             <div className='flex justify-end flex-[1_1_1] items-center gap-6 pb-4 text-[20px] font-normal' >
                ...
                {   token
                    ?<div className='user'>
                        <div className='relative flex gap-2 p-2 hover:bg-zinc-400 rounded-3xl cursor-pointer'>
                        {userName}
                        ...
                        <div className='sub-user hidden  absolute left-[px] top-[60px] rounded-3xl p-2 bg-white shadow-2xl w-[160px] '>
                            ...
                            <img src={logOut} className='w-[28px]' alt="" />
                            </button>
                    ...
                    :<div className=' hover:bg-zinc-400 rounded-3xl p-2'>
                        <Link to="/login" className='flex items-center gap-2 '>Sign in
                        <img src={userImg} alt="" className='w-[28px] ' />
